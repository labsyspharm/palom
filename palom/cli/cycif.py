...
def main(argv=sys.argv):
    ...
    parser = argparse.ArgumentParser(
        description=(
            'Align multiple TIF images of the same biospecimen and write a merged'
            ' pyramidal ome-tiff'
        )
    )
    parser.add_argument(
...
def show_info(args):
    ...
    if info_type == 'example':
        info_path = schema.cycif_config_example_path
    else:
        info_path = schema.cycif_config_schema_path
